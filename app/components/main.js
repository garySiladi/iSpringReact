    ...
    if (this.state.data) {
      content = (
        <BootstrapTable exportCSV search data={this.state.data} options={this.options} striped={true} hover={true}>
          ...
          <TableHeaderColumn dataField="name" width="100" dataSort={true}>Name</TableHeaderColumn>
          <TableHeaderColumn dataField="email" width="100" dataSort={true}>Email</TableHeaderColumn>
          <TableHeaderColumn dataField="class" width="100" dataSort={true}>Class</TableHeaderColumn>
          <TableHeaderColumn dataField="title" width="100" dataSort={true}>Title</TableHeaderColumn>
          ...
          <TableHeaderColumn dataField="percentage" width="100" dataFormat={this.percFormatter} dataSort={true}>%</TableHeaderColumn>
